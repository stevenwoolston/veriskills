...
function wwd_thumbnail_grid($attr) {
    ...
    $total_columns = !$attr['columns'] ? 3 : $attr['columns'];
    ...
    foreach($posts as $imagePost){
        $output .= "<div class='thumbnail-item' style='width:" .round(100/$total_columns). "%'>";
...
function wwd_carousel($attr) {
    ...
    foreach($posts as $imagePost){
        ...
        $output .= "    <div class='carousel-caption d-none d-md-block text-center'>";
