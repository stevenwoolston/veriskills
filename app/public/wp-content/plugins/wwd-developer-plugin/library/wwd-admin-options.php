...
function wwd_add_admin_page() {
    add_menu_page( 'WWD Theme Options', 'Theme Settings', 'manage_options', 'wwd_plugin', 'wwd_theme_create_settings_page', plugins_url('wwd-developer-plugin/images/ico.png'), 90 );
